...
| --- | --- | --- | --- | --- |
| TimesFM 2.5 200M | 다중 도메인 시계열용 파운데이션 Transformer 모델 | - | [google/timesfm-2.5-200m-pytorch](https://huggingface.co/google/timesfm-2.5-200m-pytorch) | Foundation Transformer |
