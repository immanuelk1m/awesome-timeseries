...
| --- | --- | --- |
| [Forecasting: Principles & Practice 3rd ed](https://www.youtube.com/watch?v=uwKiT1o1TkI&list=PLyCNZ_xXGzpm7W9jLqbIyBAiSO5jDwJeE&index=1) | Video playlist companion to the FPP3 forecasting textbook, covering core forecasting concepts and methods. | Video course |
| [Microprediction](https://github.com/microprediction) | Entry point to the Microprediction ecosystem, including related resources on prediction streams, forecasting, and the Microprediction book/project. | Resource hub |
...
| Probabilistic Carbon Price Transformer | Hybrid QRTransformer-MIDAS model that combines quantile regression, Transformer, and mixed-frequency MIDAS modeling for point, interval, and probabilistic carbon-price forecasting. | [Paper](https://www.sciencedirect.com/science/article/pii/S0306261925006816) | - | Probabilistic forecasting / mixed-frequency |
...
| CMamba | Channel-correlation-enhanced state space model for multivariate time series forecasting. | [arXiv:2406.05316](https://arxiv.org/abs/2406.05316) | [zclzcl0223/CMamba](https://github.com/zclzcl0223/CMamba) | Mamba / SSM |
...
| S-Mamba | Mamba-based forecasting model that uses a bidirectional Mamba block and feed-forward network to model inter-variate correlations and temporal dependencies. | [arXiv:2403.11144](https://arxiv.org/abs/2403.11144) | [wzhwzhwzh0921/S-D-Mamba](https://github.com/wzhwzhwzh0921/S-D-Mamba) | Mamba / SSM |
...
| TiRex | xLSTM-based zero-shot forecasting model designed for both short- and long-horizon forecasting, with enhanced in-context learning and explicit emphasis on state tracking. | [arXiv:2505.23719](https://arxiv.org/abs/2505.23719) | - | xLSTM / ICL / Zero-shot |
...
| Moirai 2.0 | Decoder-only time-series foundation model that uses quantile forecasting and multi-token prediction to improve probabilistic accuracy, inference efficiency, and model-size tradeoffs over earlier Moirai variants. | [arXiv:2511.11698](https://arxiv.org/abs/2511.11698) | - | Decoder-only / Quantile forecasting |
...
| --- | --- | --- |
| FinMultiTime | Four-modal bilingual financial time-series dataset aligning news, financial tables, K-line charts, and stock price series across U.S. and China markets. | [arXiv:2506.05019](https://arxiv.org/abs/2506.05019) |
...
| TimeCopilot | Open-source forecasting agent that combines LLMs with time-series foundation models such as Chronos, Moirai, TimesFM, and TimeGPT to automate and explain forecasting workflows. | [TimeCopilot/timecopilot](https://github.com/TimeCopilot/timecopilot) |
...
| GIFT Evaluation Leaderboard | Benchmark and leaderboard for general time series forecasting from the GIFT-Eval project. | [Hugging Face Space](https://huggingface.co/spaces/Salesforce/GIFT-Eval) |
| TAB | Unified benchmarking library and leaderboard for time-series anomaly detection methods, covering evaluation pipelines, baselines, metrics, and public results. | [GitHub](https://github.com/decisionintelligence/TAB) |
...
| [data-science-template](https://github.com/CodeCutTech/data-science-template) | Cookiecutter-style template for building maintainable and reproducible data science projects. |
...
| awesome-industrial-anomaly-detection | Curated list of papers, datasets, and benchmarks for industrial image anomaly and defect detection. | [GitHub](https://github.com/M-3LAB/awesome-industrial-anomaly-detection) |
